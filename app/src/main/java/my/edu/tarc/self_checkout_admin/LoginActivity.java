...
import my.edu.tarc.self_checkout_admin.Model.Admins;
// import  my.edu.tarc.self_checkout_admin.Prevalent.Prevalent;
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(username).exists()) {
                    Admins adminsData = dataSnapshot.child(username).getValue(Admins.class);

                    if (adminsData.getUsername().equals(username)) {
